...
//----------------------------------------------------------------------
// Interrupt::PrintInt
// 	Print out the integer value to screen with seperate line.
// 	Writen by: Chan-Wei Hu
//----------------------------------------------------------------------
void 
...
{
	DEBUG(dbChanwei, "CreateFile in interrupt.cc ok!");
...
{
	DEBUG(dbChanwei, "OpenFile in interrupt.cc ok!");
...
{
	DEBUG(dbChanwei, "WriteFile in interrupt.cc ok!");
...
{
    DEBUG(dbChanwei, "ReadFile in interrupt.cc ok!");
...
{
    DEBUG(dbChanwei, "CloseFile in interrupt.cc ok!\n");
