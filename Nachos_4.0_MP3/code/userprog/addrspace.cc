...
bool AddrSpace::usedPhyPage[NumPhysPages] = {0};	// initialize pPageTable used state
//----------------------------------------------------------------------
// SwapHeader
...
// how big is address space?
	...
	// Assign physical address to logical address with
	// the first found unused physical address.
    ...
    ASSERT(numPages <= NumPhysPages);		// check we're not trying
						...
						// virtual memory
	//cout << "Number of physical pages: " << NumPhysPages << "\n" << endl;
...
// Note: this code assumes that virtual address = physical address
	...
	if (noffH.code.size > 0) {
		...
		//cout << "Initializing code segment." << "\n" << noffH.code.virtualAddr << ", " << noffH.code.size << "\n";
    	executable->ReadAt(
    ...
    if (noffH.initData.size > 0) {
		...
		//cout << "Initializing data segment." << "\n" << noffH.initData.virtualAddr << ", " << noffH.initData.size << "\n";
        executable->ReadAt(
