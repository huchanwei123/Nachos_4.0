...
Kernel::Initialize()
{
	...
	threadNum = threadNum + 2;	// avoid thread 1, which is always for postal worker
	// end Chanwei add
...
int Kernel::Exec(char* name, int priority)
{
	...
	// create new thread with priority
...
{
	DEBUG(dbChanwei, "CloseFile in kernel.cc ok!");
