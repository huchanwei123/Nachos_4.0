...
{ 
    ...
    if (format) {
		...
		DEBUG(dbgFile, "mapHdr write back successed !!!!");
		dirHdr->WriteBack(DirectorySector);
		DEBUG(dbgFile, "dirHdr wrtie back successed !!!!");
		...
		DEBUG(dbgFile, "freeMapFile openfile succeed !!!!");
        directoryFile = new OpenFile(DirectorySector);
     	DEBUG(dbgFile, "directoryFile open succeed !!!!");
...
{ 
    ...
    printf("[Remove] BasePath = %s, filename = %s", BasePath, filename);
